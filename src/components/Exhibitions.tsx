...
const exhibitions = [
  {
    ...
    venue: 'Nick Lo Conte Gallery',
    location: 'New York, USA',
    date: 'March 14 – April 18',
    description: 'A curated group exhibition celebrating the magnetic pull of art, featuring Mithila folk art alongside contemporary works.',
    highlight: true,
  },
  {
    ...
    location: 'New York, USA',
    date: 'Cultural Event',
    description: 'Presented Madhubani artwork to dignitaries, showcasing the beauty of Mithila folk art on an international diplomatic platform.',
    highlight: true,
  },
  {
    title: 'Mithila Heritage Exhibition',
    venue: 'Cultural Arts Center',
    location: 'New Jersey, USA',
    date: 'Annual Exhibition',
    description: 'A dedicated showcase of traditional and contemporary Madhubani paintings, celebrating Bihar\'s rich artistic heritage.',
    highlight: false,
  },
  {
    ...
    location: 'USA',
    date: 'Seasonal Show',
    description: 'Fusion of traditional Mithila motifs with modern themes, including the acclaimed Thanksgiving Turkey series.',
    highlight: false,
  },
];

const achievements = [
  'Featured at the Consulate General of India, New York',
  'Participant in curated group exhibitions across the US',
  'Building a global community of Madhubani art enthusiasts',
  'Fusion of traditional Mithila art with contemporary themes',
  'Custom artwork for private collectors worldwide',
  'Workshops and demonstrations for cultural preservation',
];
